...
The system is a full-stack implementation comprising a React-based frontend, a FastAPI backend, and an Agentic Retrieval-Augmented Generation (RAG) reasoning engine powered by Llama 3.2 \cite{...}. The architecture is designed to optimize retrieval efficiency, minimize hallucinations, and support multilingual, multimodal interaction.
