...
\textbf{Components:}
\begin{itemize}
    \item \textbf{RAG Knowledge Base:} Stores structured data related to donation, healthcare, and blood services. This database is periodically updated.
...
\begin{enumerate}
    ...
    \item \textbf{Data Retrieval} $\rightarrow$ Data Layer (RAG Knowledge Base, User Persona, and Blood Donation DB)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{chapters/chat1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{chapters/userrouted.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{chapters/Ticket Content 1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{chapters/analytics_dash.png}
